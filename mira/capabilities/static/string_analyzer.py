...
def extract_strings(
    ...
    *,
    ...
    if not isinstance(min_length, int) or not 3 <= min_length <= 256:
        return result_error(artifact.artifact_id, "extract_strings", "INVALID_INPUT", "min_length must be between 3 and 256")
